...
public class XPath2Assertion extends AbstractScopedAssertion implements Serializable, Assertion {
    ...
    private static final String EXPECTEDVALUE_KEY = "XPath.expectedvalue"; // $NON-NLS-1$
    ...
    public AssertionResult getResult(SampleResult response) {
        ...
        try {
            XPathUtil.computeAssertionResultUsingSaxon(result, responseData, getXPathString(),
                    getNamespaces(),isNegated(),getExpectedValueString());
    ...
    public String getExpectedValueString() {
    	return getPropertyAsString(EXPECTEDVALUE_KEY,"");
    }
    /**
    ...
    public void setExpectedValueString(String expectedpath) {
    	setProperty(new StringProperty(EXPECTEDVALUE_KEY,expectedpath));
    }
