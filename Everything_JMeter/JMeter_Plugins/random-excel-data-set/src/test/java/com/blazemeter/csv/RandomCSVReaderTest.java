...
public class RandomCSVReaderTest {
    ...
    public void testRandomReadWithHeaderAndWithoutRepeat() throws Exception {
        ...
        RandomExcelReader reader = new RandomExcelReader(path, "UTF-8", ",", true, false, false, false);
    ...
    public void testReadWithHeaderAndRepeat() throws Exception {
        ...
        RandomExcelReader reader = new RandomExcelReader(path, "UTF-8", ",", false, false, true, true);
    ...
    public void testRecordsCount() throws Exception {
        ...
        reader = new RandomExcelReader(path, "UTF-8", ",", true, true, true, false);
        assertEquals(3, getRecordsCount(reader, 10, true));
        reader = new RandomExcelReader(path, "UTF-8", ",", true, false, true, false);
        assertEquals(3, getRecordsCount(reader, 10, true));
        reader = new RandomExcelReader(path, "UTF-8", ",", true, true, false, false);
        assertEquals(4, getRecordsCount(reader, 10, true));


        // test consistent
        reader = new RandomExcelReader(path, "UTF-8", ",", false, false, false, false);
        assertEquals(3, getRecordsCount(reader, 3, false));
        reader = new RandomExcelReader(path, "UTF-8", ",", false, true, true, false);
        assertEquals(3, getRecordsCount(reader, 3, false));
        reader = new RandomExcelReader(path, "UTF-8", ",", false, false, true, false);
        assertEquals(3, getRecordsCount(reader, 3, false));
        reader = new RandomExcelReader(path, "UTF-8", ",", false, true, false, false);
        assertEquals(4, getRecordsCount(reader, 4, false));
    }

    private int getRecordsCount(RandomExcelReader reader, int maxRecordsCount, boolean isRandom) {
        int i = 0;
    ...
    public void testTabDelimiter() throws Exception {
        ...
        RandomExcelReader reader = new RandomExcelReader(path, "UTF-8", "\t", false, false, false, false);
    ...
    public void testEmptyLastLine() throws Exception {
        ...
        RandomExcelReader reader = new RandomExcelReader(path, "UTF-8", " ", true, true, true, false);
